...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, ProductEventDeserializer.class.getName());
    ...
    public ConsumerFactory<String, ProductEvent> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(), new StringDeserializer(), new ErrorHandlingDeserializer<>(new ProductEventDeserializer()));
    }
